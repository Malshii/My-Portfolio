...
export const skillGroups = [
  ...
  },
  {
    ...
    skills: ["Python", "C++", "PLC Programming", "Arduino", "Raspberry Pi", "Proteus"],
  },
  {
    title: "Engineering Operations",
    Icon: PiHardHat,
    accent: "from-[#00C896]/80 via-[#7FFFD4]/55 to-[#7FFFD4]/80",
    skills: ["Engineering Designs", "Machine Commissioning", "Machine Maintenance", "Process Optimization", "Project Handling", "Automation"],
  },
];
